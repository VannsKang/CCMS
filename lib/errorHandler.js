...
var init = function() {
  ...
  map.set('NO_PERMISSION', 'You have no permission for current action.');
  map.set('NOT_APPROVED_YET', 'You have not approved from your recommender. Contact the recommender and push him to approve to join CCMS!');
};
